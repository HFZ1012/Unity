...
public class PlayServiceCustomLBExample : MonoBehaviour {
	...
	//example
	private const string LEADERBOARD_ID = "CgkIz67q1NkVEAIQBg";
	...
	public void chamar(){
		...
		Application.LoadLevel ("WeaponScene");
	...
	void Start() {
		...
		score1 = PlayerPrefs.GetInt ("vitoria");
	...
	void FixedUpdate() {
		...
		SubmitScoreButton.text = "Submit Score: " + score1;
		if(GooglePlayConnection.State == GPConnectionState.STATE_CONNECTED) {
	...
	private void SubmitScore() {
		GooglePlayManager.instance.SubmitScoreById(LEADERBOARD_ID, score1);
		SA_StatusBar.text = "Submitiong score: " + score1.ToString();
